			...
			<div className="row text-center text-xs-center text-sm-left text-md-left">
				<div className="col-xs-12 col-sm-4 col-md-4">
					...
					<ul className="list-unstyled quick-links">
						<li><a href="#"><i className="fa fa-angle-double-right"></i>All Matches</a></li>
						<li><a href="#"><i className="fa fa-angle-double-right"></i>All Teams</a></li>
						<li><a href="#"><i className="fa fa-angle-double-right"></i>All competitions</a></li>
